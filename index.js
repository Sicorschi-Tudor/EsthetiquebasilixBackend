...
app.get("https://esthetiquebasilixbackend.onrender.com/", (req, res) => {
  res.send("Server is ready")
})

app.get(
  "https://esthetiquebasilixbackend.onrender.com/api/reservation",
  (req, res) => {
...
app.post(
  "https://esthetiquebasilixbackend.onrender.com//api/send-email",
  async (req, res) => {
